...
public class IncomePhotoFragment extends DialogFragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mPhotoFile = IncomeLab.get(getActivity()).getPhotoFile(mIncome);
    }
    ...
    public static IncomePhotoFragment newInstance(Income income) {
        IncomePhotoFragment fragment = new IncomePhotoFragment();
        mIncome = income;
        return fragment;
    }
}
